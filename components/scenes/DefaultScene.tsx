    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ transform: 'translateX(-50%) translateY(-50%) translateZ(-250px)' }}
        >
        ...
        {/* Front Layer */}
         <div
          className="absolute top-1/2 left-1/2 w-1/2 h-1/2 p-4 border-2 border-sky-400/80 rounded-2xl bg-sky-800/20 backdrop-blur-lg flex items-end justify-end shadow-[0_0_30px_rgba(72,187,255,0.4)]"
          style={{ transform: 'translateX(-50%) translateY(-50%) translateZ(150px)' }}
        >
        ...
        {/* Floating element */}
         <div
          ...
          style={{ transform: 'translateX(-50%) translateY(-50%) translateZ(80px)' }}
        >
